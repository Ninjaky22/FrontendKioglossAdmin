    ...
    <PageContainer title="Gestión de Usuarios" breadcrumbs={[{ title: 'Usuarios' }]}>
      ...
      >
        ...
        <Box sx={{ 
          ...
          '& .MuiTablePagination-select, & .MuiTablePagination-actions .MuiIconButton-root': { backgroundColor: isDark ? 'rgba(0, 0, 0, 0.4)' : theme.palette.background.paper, color: listTextColor },
